...
export default class SEARCH {
    ...
    async searchByName() {
        ...
        try {
            const response = await fetch(`https://www.themealdb.com/api/json/v1/1/search.php?s=${this.cat}`, {
                method: 'GET',
                cache: 'default',

            });
            const result = await response.json();
            console.log(result.meals); //arrayof object
            //display result
            ...
            $(document).ready(function() {
                ...
                //____________________to return any id after pressed on any card and display meal info________________________
    ...
    async searchByFirstLetter() {
        load_page.classList.replace('hidden', 'flex');
        try {
            const response = await fetch(`https://www.themealdb.com/api/json/v1/1/search.php?f=${this.cat}`, {
                method: 'GET',
                cache: 'default',
